...
export function KeyboardShortcutHint({
  ...
  return (
    <kbd
      className={`pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded-md border border-border/40 bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground ${className || ""}`}
    >
      {shortcut}
    </kbd>
  );
