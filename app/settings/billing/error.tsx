...
import { CreditCard, RefreshCw, Settings, HelpCircle } from "lucide-react";
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              We couldn&apos;t load your billing settings. Your subscription is
              not affected.
            </p>
