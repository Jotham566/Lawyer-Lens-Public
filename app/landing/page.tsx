          ...
          <AnimatedSection variant="fade-up">
            <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-14">
              ...
              <div className="lg:col-span-5">
                ...
                <p className="mt-10 text-xs font-semibold uppercase tracking-[0.15em] text-muted-foreground/60">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-2 divide-x divide-border/30 sm:grid-cols-4">
              {[
                ...
                <div key={stat.label} className="px-6 py-5 text-center">
                  ...
                  <span className="mt-0.5 block text-xs font-semibold uppercase tracking-widest text-muted-foreground">
                    {stat.label}
                  </span>
                </div>
              ))}
            ...
            <div className="mt-10 grid gap-0 md:grid-cols-3">
              {[
                ...
                >
                  ...
                  <h3 className="mt-1.5 text-[17px] font-bold tracking-tight">
                    {pillar.title}
                  </h3>
          ...
          <AnimatedSection variant="fade-up">
            <div className="grid items-center gap-10 lg:grid-cols-[5fr_7fr] lg:gap-14">
              ...
              <div>
                ...
                <p className="mt-4 text-xs font-semibold uppercase tracking-widest text-brand-gold/70">
