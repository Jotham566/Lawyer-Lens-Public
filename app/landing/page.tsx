    ...
    <>
      ...
      <section className="relative isolate overflow-hidden pt-32 pb-0 lg:pt-40">
        ...
        <AnimatedSection variant="fade-up" delay={200}>
          <div className="mt-16 border-y border-border/30 bg-surface-container-low/50 dark:bg-surface-container/30">
            <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-4 px-6 py-6 lg:px-12 xl:px-20">
              {[
                { figure: totalDocuments ? `${totalDocuments}+` : "—", label: "Legal documents indexed" },
                { figure: "99%", label: "Citation accuracy" },
                { figure: "<3s", label: "Average response time" },
                { figure: "Live", label: "Now available in Uganda" },
              ].map((stat) => (
        ...
        <div className="px-6 lg:px-12 xl:px-20">
          <AnimatedSection variant="fade-up">
            <div className="grid gap-16 md:grid-cols-2 md:gap-0">
              {/* Why It Matters */}
              <div className="md:border-r md:border-border/30 md:pr-14 lg:pr-20">
                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-brand-gold">
                  Why It Matters
                </p>
      ...
      {/* ─────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────── */}
      <section id="product" className="border-t border-border/30 py-16 lg:py-20">
        <div className="px-6 lg:px-12 xl:px-20">
          <AnimatedSection variant="fade-up">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-brand-gold">
              How It Works
          ...
          <AnimatedSection variant="fade-up" delay={100}>
            <div className="mt-14 grid gap-0 md:grid-cols-3">
              {[
                ...
                <div
                  key={pillar.step}
                  className={`relative py-0 ${i < 2 ? "md:border-r md:border-border/30 md:pr-10 lg:pr-14" : ""} ${i > 0 ? "mt-10 md:mt-0 md:pl-10 lg:pl-14" : ""}`}
                >
                  <span className="text-4xl font-extrabold text-brand-gold/20">
                    {pillar.step}
                  </span>
      ...
      {/* ─────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────── */}
      <section id="features" className="border-t border-border/30 py-16 lg:py-20">
        <div className="px-6 lg:px-12 xl:px-20">
          <AnimatedSection variant="fade-up">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-brand-gold">
              Use Cases
